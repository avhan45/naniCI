          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-2 mb-1"> Edit Data Guru</h4>
              <div class="row">
                <!-- Basic -->
                <div class="col-xl-8">
                  <!-- HTML5 Inputs -->
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url('guru/edit_proses'); ?>" method="POST">
                        <?php foreach($data_guru as $data): ?>
                      <div class="mb-3 row">
                        <label for="html5-text-input" class="col-md-2 col-form-label">Nama</label>
                        <div class="col-md-10">
                          <input class="form-control" type="hidden" name="id" value="<?= $data->id_guru ?>" />
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                          <input class="form-control" type="text" name="nip" value="<?= $data->nip; ?>" id="html5-search-input" />
                        </div>
